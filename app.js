...
const monthsData = [
    ...
    },
    {
      abbr: "04/24",
      month: "Abril '24",
      intro: "Primer viatjet junts a Madrizzz amb la meva lady. Època marcada per la tortura dels pierciengs i el TFG, res que encendre una 'espelma' no solucionés jeje",
    ...
    },
    {
      abbr: "05/24",
      month: "Maig '24",
      intro: "Més TFG, primer dinar amb la meva family, i jo perfi vaig començar a treballar! Amb alguna que altra avantatge :)",
    ...
    },
    {
      abbr: "07/24",
      month: "Juliol '24",
      intro: "Aquest més ens vam veure massa poc, i jo a distància no parava d'imaginar-te amb poca roba...",
